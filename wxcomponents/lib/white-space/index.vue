<template>
<uni-shadow-root class="lib-white-space-index"><view :class="'wux-class '+(classes.wrap)" :style="extStyle" onTap="onTap"></view></uni-shadow-root>
</template>

<script>

global['__wxRoute'] = 'lib/white-space/index'
...
export default global['__wxComponents']['lib/white-space/index']
</script>
