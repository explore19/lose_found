<template>
<uni-shadow-root class="lib-timeago-index"><text :class="'wux-class '+(prefixCls)">{{ timeago }}</text></uni-shadow-root>
</template>

<script>

global['__wxRoute'] = 'lib/timeago/index'
...
export default global['__wxComponents']['lib/timeago/index']
</script>
