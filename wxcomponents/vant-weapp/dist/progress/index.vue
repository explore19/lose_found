<template>
<uni-shadow-root class="vant-weapp-dist-progress-index"><view class="van-progress custom-class" :style="'height: '+(strokeWidthUnit)+'; '+(trackColor ? 'background: ' + trackColor : '')">
